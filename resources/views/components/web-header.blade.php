        ...
        <div class="container">
            <div class="header-part">
                <a href="{{ route('home') }}" title="{{ env('APP_NAME') }}" class="logo">
                    <img src="{{ asset('images/logo.png') }}" alt="{{ env('APP_NAME') }} Logo" title="{{ env('APP_NAME') }} Logo">
                </a>
                <form class="search-bar border">
                    <label for="search" class="bi bi-search"></label>
                    <input type="search" name="s" id="search" class="form-control border-0" autocomplete="off" placeholder="Search">
                </form>
